...
(function() {
  ...
  EnoceanPlatform = function(log, config1, api) {
    ...
    this.api.on('didFinishLaunching', () => {
      ...
      if (this.staleAccessories.length > 0) {
        this.log("Removing accessories not present in configuration");
      }
      this.api.unregisterPlatformAccessories('homebridge-enocean-zonefuenf', 'enocean-zonefuenf', this.staleAccessories);
  ...
  EnoceanPlatform.prototype.configureAccessory = function(accessory) {
    ...
    if (!this.config.accessories.find(function(c) {
      return c.id === serial;
    })) {
      this.log('Schedule accessory for removal:', accessory.displayName);
